...
COST.tax = 0.3890; % Income Tax = Federal + State
...
COST.catalyst.year = 7; % year, replacement interval of major components
...
COST.feed.CO2 = 0.06; %$/kg 
COST.feed.CH = materials.price_raw_materials{AnodeCandidate(j)}; % $/kg
