function [ConvergenceState, h] = cal_process(Efficiency, CurrentDensity, potential, materials, components, input, process, h)
...
if process.order.in(12) + process.order.out(12) ~= 0 && strcmp(process.types{12},'block')
    ...
    if materials.type(components.cathode(2)) == 2 % TYPE 2
        ...
        h.Tree.FindNode(temp).value = 0.95;
